...
extension ViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        modelSelection[section].data.count
    }
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        let header = tableView.dequeueReusableHeaderFooterView(withIdentifier: customTableViewHeaderIdentifier) as? CustomHeaderView
        let model = modelSelection[section].title
        header?.configureHeader(title: model, buttonTag: section, buttonTappedCallback: expandSection)
        return header
    }
